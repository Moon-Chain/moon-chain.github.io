    ...
    <div class="col-xl-8 col-sm-12">
        ...
        <div class="widget-card widget-card-inverse">
            <div class="widget-card-col col-12 col-lg-6">
                ...
                <div class="widget-card-cover" style="background-image: url(assets/img/dashboard-cover.jpg)">
            ...
            <div class="widget-card-col col-12 col-lg-6">
                ...
                <p class="widget-desc widget-desc-inverse m-b-25">We've assembled some links to get you
                    started:</p>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-sm-6 col-12">
                ...
                <div class="widget-card widget-card-inverse" style="height: 12.45rem;">
                    ...
                    <div class="widget-card-cover" style="background-image: url(assets/img/dashboard-cover-1.jpg)">
                        <div class="cover-bg"></div>
                    </div>
            ...
            <div class="col-xl-12 col-sm-6 col-12">
                ...
                <div class="widget-card widget-card-inverse" style="height: 12.45rem;">
                    ...
                    <div class="widget-card-cover" style="background-image: url(assets/img/dashboard-cover-2.jpg)">
                        <div class="cover-bg"></div>
                    </div>
    ...
    <div class="col-xl-4 col-sm-6">
        ...
        <div class="card mb-3">
            ...
            <div class="widget-list">
                <a href="#" class="widget-list-item">
                    <div class="widget-list-media">
                        <div class="img" style="background-image: url(assets/img/dashboard-product-8.jpg">
                        </div>
                    </div>
                    <div class="widget-list-content">
                        <p>DJI</p>
                ...
                <a href="#" class="widget-list-item">
                    <div class="widget-list-media">
                        <div class="img" style="background-image: url(assets/img/dashboard-product-10.jpg">
                        </div>
                    </div>
                    <div class="widget-list-content">
                        <p>SONY</p>
                ...
                <a href="#" class="widget-list-item">
                    <div class="widget-list-media">
                        <div class="img" style="background-image: url(assets/img/dashboard-product-11.jpg">
                        </div>
                    </div>
                    <div class="widget-list-content">
                        <p>LUMIX</p>
                ...
                <a href="#" class="widget-list-item">
                    <div class="widget-list-media">
                        <div class="img" style="background-image: url(assets/img/dashboard-product-12.jpg">
                        </div>
                    </div>
                    <div class="widget-list-content">
                        <p>DJI</p>
                ...
                <a href="#" class="widget-list-item">
                    <div class="widget-list-media">
                        <div class="img" style="background-image: url(assets/img/dashboard-product-13.jpg">
                        </div>
                    </div>
                    <div class="widget-list-content">
                        <p>CANON</p>
    ...
    <div class="col-xl-4 col-sm-6">
        ...
        <div class="card mb-3">
            ...
            <div class="widget-card widget-card-inverse full dynamic text-center">
                <div class="widget-card-cover" style="background-image: url(assets/img/dashboard-cover-5.jpg)">
                    <div class="cover-bg"></div>
                </div>
                <div class="widget-card-content">
            ...
            <div class="widget-list">
                <a href="#" class="widget-list-item">
                    <div class="widget-list-media">
                        <div class="img" style="background-image: url(assets/img/dashboard-product-9.jpg">
                        </div>
                    </div>
                    <div class="widget-list-content">
                    ...
                    <div class="widget-chat-item">
                        ...
                        <div class="widget-chat-content">
                            ...
                            <div class="widget-chat-message">
                                Not much, It's got a new look, contact pics show up in group messaging, some
                                other small stuff.
                            </div>
                            <div class="widget-chat-message last">
    ...
    <div class="col-xl-4 col-sm-6">
        ...
        <div class="card mb-3">
            ...
            <div class="widget-img-list">
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-1.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-2.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-3.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-4.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-5.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-21.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-22.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-23.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-24.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-25.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-26.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-27.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-28.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-29.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-30.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-31.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-32.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-33.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-34.jpg)" alt="" class="img"></span></a></div>
                <div class="widget-img-list-item"><a href="#" style="padding-top: 79px"><span class="img" style="background-image: url(assets/img/gallery/gallery-35.jpg)" alt="" class="img"></span></a></div>
            </div>
