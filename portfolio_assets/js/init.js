...
function tokyo_tm_modalbox_about(){
	...
	var modalBox	= jQuery('.modal_1');
	var opener		= jQuery('.tokyo_tm_about .button_learn_more a');
...
function tokyo_tm_modalbox_spotify(){
	
	"use strict";
	
	var modalBox	= jQuery('.modal_2');
	var opener		= jQuery('.tokyo_tm_about .button_spotify a');
	var closer		= modalBox.find('.close');
